...
public class TrafficLightController extends Device implements Runnable, GenerateFine {
    ...
    private final BigDecimal RED_LIGHT_FINE_AMOUNT = BigDecimal.valueOf(300000.00);
    private final int RED_LIGHT_POINT_SCORING = 5;
    ...
    public void fineGenerate() {
        try {
            ...
            TrafficFine fine = new RedLightFine(
                    0,
                    RED_LIGHT_POINT_SCORING,
                    TypesInfraction.RED_LIGHT,
                    randomAuto,
                    location,
                    RED_LIGHT_FINE_AMOUNT
            );

            new TrafficFineDAO().saveFine(fine);
            System.out.println("🚨 Traffic light fine generated 🚨");
